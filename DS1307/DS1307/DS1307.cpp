...
char *DS1307::getDOWStr(uint8_t format)
{
	...
	{
		case MONDAY:
			output="Segunda"; //output="Monday";
			break;
		case TUESDAY:
			output="Terca"; //output="Tuesday";
			break;
		case WEDNESDAY:
			output="Quarta"; //output="Wednesday";
			break;
		case THURSDAY:
			output="Quinta"; //output="Thursday";
			break;
		case FRIDAY:
			output="Sexta"; //output="Friday";
			break;
		case SATURDAY:
			output="Sabado"; //output="Saturday";
			break;
		case SUNDAY:
			output="Domingo"; //output="Sunday";
			break;
	}     
	if (format==FORMAT_SHORT)
		output[3]=0;
